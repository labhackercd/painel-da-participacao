...
function SectionHeader(props) {
  ...
  const { title, toolColor } = props;

  return (
    <Box className={classes.toolSectionHeader} style={{ color: toolColor }}>
      <Typography component="div" variant="h2">
        <Box
          className={`${classes.typography} ${classes.toolSectionTypograhyTitle}`}
        >
          {title}
        </Box>
      </Typography>
          ...
          <Box className={classes.textBoxMargin}>
            ...
            <Box className={classes.criteriesSection}>
              ...
              <Typography
                ...
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                Considera-se participação - para efeito dos dados exibidos no
                painel - toda ação de interação nas ferramentas, realizada
                apenas pelos usuários logados, tais como: envio de mensagens,
                perguntas, opiniões ou votos em perguntas ou opiniões de outros
                cidadãos.
              </Typography>
              ...
              <Typography
                ...
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                Usuários são todos aqueles que realizaram cadastro para utilizar
                as ferramentas de participação. Não importa nessa definição se
                os usuários logados efetivamente participaram, se somente se
                cadastraram ou se apenas visualizaram os conteúdos.
              </Typography>
              ...
              <Typography
                ...
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                Participantes são os usuários que realizaram uma ou mais
                interações efetivas , que são contabilizadas como participação -
              ...
              <Typography
                ...
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                Como cada participante é contabilizado uma única vez por
                período, o total de um ano não será a simples soma de todos os
                meses, de modo a evitar contagens repetidas do mesmo
                participante. Se, por exemplo, um mesmo participante enviar
                mensagens em meses diferentes de 2019, será contabilizada sua
              ...
              <Typography
                ...
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                Quando o painel mostrar totais ou números acumulados, estes se
                referem apenas ao período de tempo selecionado na busca.
              </Typography>
            </Box>
            ...
            <>
              ...
              <Typography
                ...
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                O total de participantes inclui apenas usuários que enviaram
              ...
              <Typography
                ...
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                No gráfico de Distribuição da participação no período, são
                mostrados totais referentes às ações efetuadas pelos
                participantes: perguntas, mensagens e votos. A distribuição é
                feita de acordo com a data em que a ação ocorreu - primeiramente
                associando-se ao dia, depois ao mês e por último ao ano - a
                depender do período selecionado na busca.
              </Typography>
              <Typography
                component="p"
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                A distribuição da participação é apresentada de três formas, a
                depender do período de busca escolhido: (1) todos os anos
                disponíveis, caso seja selecionado “Todo o período”, (2) um
                máximo de 12 meses, caso seja selecionado um determinado ano e
                “todos os meses”; e (3) o intervalo de até 31 dias, em 1 mês
                determinado.
              </Typography>
              ...
              <Typography
                ...
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                A tabela Ranking das audiências permite a discriminação de
                detalhes referentes às audiências realizadas ou canceladas, bem
                como os respectivos quantitativos da participação, no período
                selecionado. A tabela é pré-ordenada pelo maior número de
                participantes, mas é possível alterar a ordem nas diferentes
                colunas.
              </Typography>
              <Typography
                component="p"
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                Nesta tabela, os somatórios de participantes, perguntas, votos
                (nas perguntas) e mensagens são contabilizados por audiência. Em
                outras palavras, o somatório é feito quando já não é mais
                possível para o cidadão participar, após a audiência (ou evento
                interativo) ter sido realizada ou cancelada.
              </Typography>
              ...
              <Typography
                ...
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                Os gráficos - a depender do período - revelam um crescimento
                repentino de cadastros nos meses de setembro e de novembro de
                2017. A explicação se dá pelo fato de a ferramenta Audiências
                Interativas ter sido desenvolvida em 2016 com uma base de
                usuários própria. Em 2017, quando uma nova versão da plataforma
              ...
              >
                <AnchorTag
                  url={`${process.env.NEXT_PUBLIC_AUDIENCIAS_SWAGGER_URL}`}
                >
            ...
            <>
              ...
              <Typography
                ...
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                O somatório dos dados referentes ao período filtrado pelo
                usuário - pode ser relativo a um mês, um ano ou todo o período.
              </Typography>
              <Typography
                component="p"
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                ...
                interações enquanto a proposta legislativa esteve aberta à
                participação na Wikilegis e - especificamente - dentro do
                período definido na busca.
              </Typography>
              <Typography
                component="p"
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                Cada participante é contabilizado uma única vez, mesmo
                realizando uma ou mais ações dentro do período selecionado na
                busca.
              </Typography>
              <Typography
                component="p"
              ...
              >
                A distribuição da participação é apresentada de três formas, a
                depender do período: (1) todos os anos disponíveis, caso seja
                selecionado “Todo o período”, (2) um máximo de 12 meses, caso
                seja selecionado um determinado ano e “todos os meses”; e (3) o
                intervalo de até 31 dias, em 1 mês determinado.
              </Typography>
              ...
              <Typography
                ...
                className={`${classes.typography} ${classes.typographyParagraph}`}
              >
                Os somatórios de participantes, opiniões e votos nas opiniões
              ...
              >
                ...
                ferramentas de participação que viessem a ser desenvolvidas no
                LABHacker - , buscou-se a base de usuários do antigo
                e-Democracia então unificada ao “login cidadão” da Câmara dos
                Deputados.
              </Typography>
              ...
              >
                <AnchorTag
                  url={`${process.env.NEXT_PUBLIC_WIKILEGIS_SWAGGER_URL}`}
                >
                  API Wikilegis
                </AnchorTag>
              </Typography>
