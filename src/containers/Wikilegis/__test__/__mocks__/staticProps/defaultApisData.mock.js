...
export const defaultApisData = {
  wikilegisRankingData: [
    {
      document: {
      ...
      get_absolute_url: '/wikilegis/p/10-prisao-em-2a-instancia/',
    },
    {
      document: {
      ...
      get_absolute_url: '/wikilegis/p/12-lei-brasileira-de-liberdade-responsabilidade-e-transparencia-na-internet/',
    },
    {
      document: {
    ...
    },
    {
      ...
      get_absolute_url: '/wikilegis/p/1-valorizacao-dos-movimentos-artisticos-de-periferia/',
    },
  ],
  wikilegisParticipantUsersAPIData: {
    count: 0,
    next: null,
    previous: null,
    results: [],
